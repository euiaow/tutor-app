# Changelog — August 2026 (sessions 9–37)

Archived from `activeContext.md` in batches (session 9 on 2026-08-02, session
10 on 2026-08-16, sessions 16-23 on 2026-08-23, sessions 24/26/27 on
2026-08-24, sessions 28-33 on 2026-08-27, sessions 34-37 on 2026-09-04 — see
`changelog/index.md` for the full per-batch breakdown). This is historical
detail for sessions already superseded by later work — durable patterns from
them live on in
